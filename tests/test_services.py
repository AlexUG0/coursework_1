...
def test_simple_search_found(df_for_tests):
    ...
    expected_filtered_list = [
        {"Дата операции": "31.12.2021 16:44:00", "Номер карты": "*7197",
         "Категория": "Супермаркеты", "Сумма платежа": -160.89, "Описание": "Колхоз"},
        {"Дата операции": "31.12.2021 15:44:39", "Номер карты": "*7197",
         "Категория": "Супермаркеты", "Сумма платежа": -78.05, "Описание": "Колхоз"}
    ]
